...
##    np.savetxt('/P/weisq/attentomo/P2.dat',dataP2[:,0])
...
##    np.savetxt('/P/weisq/attentomo/P3.dat',dataP3[:,0])
...
##        np.savetxt('/P/weisq/attentomo/S2.dat',dataS2[:,0])
...
##        np.savetxt('/P/weisq/attentomo/S3.dat',dataS3[:,0])
