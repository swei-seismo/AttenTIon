...
workdir='/mnt/home/swei/LauQtomo/tstar_fcp0.5-20MPa0.27site/'
stnlst='/mnt/home/swei/LauQtomo/input/station.lst'
...
for depth in ['300-','300+']:
    ...
    if depth=='shallow':
        ...
        deprange=[0,int(depth[0:3])]
    elif depth[3]=='+':
        deprange=[int(depth[0:3]),1000]
    for phase in ['p','s','r']:
        aveQ={}
        aveQerr={}
